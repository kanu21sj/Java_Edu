...
public class Member3Controller {
	...
	@RequestMapping("member3.mega")
	//Spring은 객체 생성이(new) 필요없음, 자동으로 만들어줌
	public void insert(Member3VO bag, Member3DAO dao) throws Exception {
		...
		System.out.println("컨트롤러에서 받은 id: " + bag.getTeam());
		System.out.println("컨트롤러에서 받은 pw: " + bag.getStatus());

	}
	
	//login.jsp에서 MemberController 넘어오게 하는 함수
	//pc는 login만 인식하고 mega는 인식못함
	@RequestMapping("login3.mega")
